...
const DeleteJadwal = ({ jadwalId }: props) => {
  ...
  return (
    <div>
      <ToastContainer containerId={`toastDelete-${jadwalId}`} />
      <button
        type="button"
      ...
      <Modal isShow={show}>
        <div className="w-full p-3">
          ...
          <span className="text-sm text-slate-500">
            Apakah anda yakin ingin menghapus jadwal kereta ini?
          </span>
